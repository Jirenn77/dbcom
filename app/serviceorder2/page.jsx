...
export default function ServiceOrderPage() {
  ...
  useEffect(() => {
    const fetchPromosAndDiscounts = async () => {
      try {
        const res = await fetch('http://localhost/API/getPromosAndDiscounts.php');
        const data = await res.json();
  ...
  const calculatedSubtotal = Math.max(totalAmount - promoReduction - discountReduction, 0);
                    ...
                    {customerName && isMember ? (
                      <>
                        ...
                        >
                          ...
                          <span className="ml-2 inline-block px-2 py-0.5 text-sm font-semibold rounded-full 
  text-white 
  bg-purple-600">
                ...
                >
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg transition-all duration-300 ${customerName
                  ...
                  {selectedServices.length > 0 && (
                    ...
                    >
                      ...
                      <div className="max-h-48 overflow-y-auto space-y-2 pr-2">
                        <AnimatePresence>
                          {[...selectedServices].sort((a, b) => a.name.localeCompare(b.name)).map((service, index) => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <motion.select
                        ...
                        value={promoApplied}
                        onChange={(e) => {
                          const selected = promos.find(p => p.id === e.target.value);
                      ...
                      >
                        ...
                        {promos
                          .filter((promo) => promo.status === "active") // ✅ Only active promos
                          .map((promo) => (
                    ...
                    <div>
                      ...
                      <motion.select
                        ...
                        value={discount}
                        onChange={(e) => {
                          const selected = discounts.find(d => Number(d.value) === Number(e.target.value));
                      ...
                      >
                        ...
                        {discounts
                          .filter((d) => d.status === "active") // ✅ Only active discounts
                          .map((d) => (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <span>₱{promoReduction.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                    </motion.div>
                    ...
                    >
                      ...
                      <span>₱{discountReduction.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                    </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white p-4 rounded-lg">
                      ...
                      <div className="space-y-2">
                        ...
                        {isMember && (
                          <>
                            <p><span className="text-gray-600">Membership:</span> {membershipType.toUpperCase()}</p>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div className="text-sm text-gray-600">
                                      {customer.isMember ? (
                                        <span>
                                          <span className="font-medium uppercase">{customer.membershipType}</span> Membership
                                          <span className="ml-1 text-blue-600">(₱{membershipBalance.toLocaleString()} remaining)</span>
                                        </span>
                                      ) : (
