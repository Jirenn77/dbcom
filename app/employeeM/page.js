                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="service" value={formData.service} onChange={handleChange} className="w-full p-2 border rounded" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="contactDetails" value={formData.contactDetails} onChange={handleChange} className="w-full p-2 border rounded" />
                            </div>
